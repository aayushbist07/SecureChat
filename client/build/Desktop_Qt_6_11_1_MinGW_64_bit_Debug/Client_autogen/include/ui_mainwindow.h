...
public:
    ...
    void setupUi(QMainWindow *ClientMainWindow)
    {
        ...
        ClientMainWindow->resize(1058, 757);
...
"border:1px solid #2A3445;"));
        ...
        horizontalLayout_5->setContentsMargins(11, -1, 11, -1);
        ...
        Chat->setStyleSheet(QString::fromUtf8("border-radius:10px;\n"
"border:1px solid #2A3445;"));
...
"}"));
        ...
        Chatlist = new QListWidget(Chatandlogoframe);
...
"}"));
        ...
        horizontalLayout_7->addWidget(Chatlist);
...
""));
        ...
        horizontalLayout_6->addWidget(Window);
...
""));
        ...
        horizontalLayout_6->addWidget(textEdit_ChatDisplay);
    ...
    void retranslateUi(QMainWindow *ClientMainWindow)
    {
        ...
        label_LogHeader->setText(QCoreApplication::translate("ClientMainWindow", "System Log", nullptr));
